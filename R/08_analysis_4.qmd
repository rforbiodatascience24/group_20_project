...
title <- "5 most enriched Pathways between fasting and postprandial cirrhosis patients"
...
res_df <- read.csv("../data/DESeq2/03_DESeq2_results-fattyliver.csv")
...
title <- "5 most enriched Pathways between fasting and postprandial for non-alcoholic fatty liver disease patients"
save_title <- "GSEA_fasting_vs_postprandial_fattyliver_patients"
plot_most_enriched_pathways(gsea_results, 
                            title,
                            save_title)
```
...
title <- "5 most enriched Pathways between fasting and postprandial healthy patients"
