...
```{r}
res_df <- read.csv("../data/03_DESeq2_results-global.csv")
```
...
```{r}
# Get gene sets
gene_sets <- msigdbr(species = "Homo sapiens", category = "C8")
```
...
res_df <- read.csv("../data/03_DESeq2_results-cirrhosis.csv")
...
res_df <- read.csv("../data/03_DESeq2_results-fasting.csv")
...
res_df <- read.csv("../data/03_DESeq2_results-postprandial.csv")
